...
const Navbar: React.FC = () => {
    ...
    <div className="container flex flex-wrap justify-between items-center mx-auto">
      <Link href="/">
            <Image className="h-10" src={Minion_url_img} alt="Minion Image one eye" width={50} height={50} />
      </Link>
      <button onClick={HandletoClickMobileNavbar} data-collapse-toggle="mobile-menu" type="button" className="inline-flex items-center p-2 ml-3 text-sm text-gray-500 rounded-lg md:hidden hover:bg-gray-100focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600" aria-controls="mobile-menu-2" aria-expanded="false">
