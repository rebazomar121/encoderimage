...
const Footer: React.FC = () => {
    ...
    return <>  <div className={closefooter === true ? "z-20 fixed inset-x-0 bottom-0 p-4 w-full text-center bg-white rounded-lg border shadow-md sm:p-8 dark:bg-gray-800 dark:border-gray-700" : "hidden"}>
        <h3 className=" text-3xl font-bold text-gray-900 dark:text-white"> <p className="text-3xl text-center ml-80 md:hidden"> <button onClick={HandleTocloseFooter}><IoMdClose /></button>  </p> Check out my github  </h3>
